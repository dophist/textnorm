...
class DateFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True, lm: bool = False):
        ...
        year_4_digit = pynini.closure(NEMO_DIGIT,4,4) + pynutil.delete("/")
        year_2_digit_with_zero = "0" + pynini.closure(NEMO_DIGIT,1,1) + pynutil.delete("/")
        ...
        date_graph = date_type0|date_type1|date_type2|date_type3|date_type4
